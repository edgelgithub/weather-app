...
<link rel="stylesheet" href="{{ asset('/css/style.css') }}">
   ...
   <body>
    ...
    <main>
        ...
        <!-- Video Start Arera -->
        <div class="video-area video-bg pt-200 pb-200"  data-background="/img/service/video-bg.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
        ...
        <!-- Testimonial Start -->
        <!-- Testimonial Start -->
        <div class="testimonial-area testimonial-padding" data-background="/img/testmonial/testimonial_bg.jpg">
            <div class="container ">
