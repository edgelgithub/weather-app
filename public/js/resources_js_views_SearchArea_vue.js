...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    selectCity: function selectCity(loc) {
      ...
      fetch("https://api.openweathermap.org/data/2.5/weather?units=metric&lat=" + loc.properties.lat + "&lon=" + loc.properties.lon + "&appid=a987e303895ee2cf56510feb0537e1c4", requestOptions).then(function (response) {
        return response.json();
      }).then(function (result) {
        _this.$emit('update:_weatherData', result);
        _this.hideResult = true;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this2.hideResult = false;
                _this2.$emit('update:_weatherData', {});
              ...
              case 4:
                ...
                fetch("https://api.geoapify.com/v1/geocode/autocomplete?filter=countrycode:jp&text=" + _this2.query + "&apiKey=ca76c36c4819436983278efd4dbbe13a", requestOptions).then(function (response) {
                  return response.json();
                }).then(function (result) {
